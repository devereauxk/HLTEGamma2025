...
from Configuration.Eras.Era_Run3_2025_cff import Run3_2025 #changed for 2025 PbPb
process = cms.Process('HiForest', Run3_2025) #changed for 2025 PbPb

###############################################################################

# HiForest info
process.load("HeavyIonsAnalysis.EventAnalysis.HiForestInfo_cfi")
process.HiForestInfo.info = cms.vstring("HiForest, miniAOD, 151X, mc") #changed for 2025 PbPb
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        '/store/user/fdamas/PbPb2025/RunPrepMC/JpsiDielectron_pTHatMin4_HydjetEmbedded_Pythia8_TuneCP5_1510pre6/ZtoEE_PAT_151X_mcRun3_2025_realistic_HI_v1/251017_023100/0000/step4_PAT_1.root'
    ),
)
...
process.GlobalTag = GlobalTag(process.GlobalTag, '151X_mcRun3_2025_realistic_HI_v1', '') #changed for 2025 PbPb
