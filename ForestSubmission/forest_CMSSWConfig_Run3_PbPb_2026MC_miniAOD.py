...
from Configuration.Eras.Era_Run3_2026_cff import Run3_2026 #changed for 2026 PbPb
process = cms.Process('HiForest', Run3_2026) #changed for 2026 PbPb

###############################################################################

# HiForest info
process.load("HeavyIonsAnalysis.EventAnalysis.HiForestInfo_cfi")
process.HiForestInfo.info = cms.vstring("HiForest, miniAOD, 151X, mc") #changed for 2025,2026 PbPb
...
process.GlobalTag = GlobalTag(process.GlobalTag, '151X_mcRun3_2025_realistic_HI_v5', '') #changed for 2026 PbPb
